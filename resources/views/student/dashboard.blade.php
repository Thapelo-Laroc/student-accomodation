              ...
              <ul class="menu-sub">
                <li class="menu-item active">
                  <a href="index.html" class="menu-link">
                    <div class="text-truncate" data-i18n="Analytics">Listed Acc</div>
                  </a>
                </li>
                <li class="menu-item">
                  <a
                    ...
                    target="_blank"
                    class="menu-link">
                    <div class="text-truncate" data-i18n="CRM">Your Res</div>
              ...
              <ul class="menu-sub">
                ...
                <li class="menu-item">
                  <a
                    ...
                    target="_blank"
                    class="menu-link">
                    <div class="text-truncate" data-i18n="CRM">Students at your res</div>
                    <!-- <div class="badge rounded-pill bg-label-primary text-uppercase fs-tiny ms-auto">Pro</div> -->
                  </a>
                </li>
              </ul>
                          ...
                          <div class="card-title d-flex align-items-start justify-content-between mb-4">
                            ...
                            <div class="dropdown">
                              ...
                              <div class="dropdown-menu dropdown-menu-end" aria-labelledby="cardOpt3">
                                <a class="dropdown-item" href="{{ route('accommodations.index') }}">View More</a>
                                <a class="dropdown-item" href="javascript:void(0);">Delete</a>
                              </div>
                            </div>
                          </div>
                          <p class="mb-1">Accommodations</p>
                          <h4 class="card-title mb-3">59</h4>
                    ...
                    <div class="col-lg-6 col-md-12 col-6 mb-6">
                      <div class="card h-100">
                        <div class="card-body">
                          ...
                          <p class="mb-1">Landlords</p>
                          <h4 class="card-title mb-3">40</h4>
